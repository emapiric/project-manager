...
(18,'NewProject','This is a new project by user a',1);
...
CREATE TABLE `project_task` (
  ...
  CONSTRAINT `project_task_ibfk_5` FOREIGN KEY (`authorId`) REFERENCES `user` (`id`)
...
(1,'Registration','Create registration form'),
(2,'Login','Create login form'),
(3,'New feature','Add new feature'),
(4,'Bug fix','Fix a bug');
